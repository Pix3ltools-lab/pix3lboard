...
export function ChecklistSection({ value, onChange }: ChecklistSectionProps) {
          ...
          {value.map(item => (
            ...
            >
              <button
                ...
                className="flex-shrink-0 text-text-secondary hover:text-accent-primary transition-colors"
              >
                {item.checked ? (
